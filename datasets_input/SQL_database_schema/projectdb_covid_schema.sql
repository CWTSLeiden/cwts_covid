...
CREATE TABLE IF NOT EXISTS `projectdb_covid`.`who_metadata` (
  ...
  `who_source` VARCHAR(500) NULL,
  `who_database` VARCHAR(255) NULL,
  `who_type` VARCHAR(255) NULL,
  `who_language` VARCHAR(255) NULL,
  `who_descriptors` VARCHAR(1000) NULL,
  `who_entry_date` VARCHAR(255) NULL,
  `pub_id` INT NOT NULL,
