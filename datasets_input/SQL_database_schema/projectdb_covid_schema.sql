...
CREATE TABLE IF NOT EXISTS `projectdb_covid`.`cord19_metadata` (
  ...
  CONSTRAINT `fk_cord19_metadata_pub`
    FOREIGN KEY (`pub_id`)
    REFERENCES `projectdb_covid`.`pub` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `projectdb_covid`.`pub_to_datasource`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `projectdb_covid`.`pub_to_datasource` ;

CREATE TABLE IF NOT EXISTS `projectdb_covid`.`pub_to_datasource` (
  `pub_id` INT NOT NULL,
  `source_id` INT NOT NULL,
  PRIMARY KEY (`pub_id`, `source_id`),
  INDEX `fk_pub_has_table1_table11_idx` (`source_id` ASC),
  ...
  CONSTRAINT `fk_pub_to_datasource_2`
    ...
    REFERENCES `projectdb_covid`.`datasource` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
